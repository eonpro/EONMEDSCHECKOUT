...
export function InjectionIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
...
export function PillIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} {...props}>
      <path d="M10.5 20.5a6.5 6.5 0 1 0 0-13 6.5 6.5 0 0 0 0 13Z"/>
      <path d="M13.5 10.5a6.5 6.5 0 1 0 0 13 6.5 6.5 0 0 0 0-13Z"/>
    </svg>
  );
}
